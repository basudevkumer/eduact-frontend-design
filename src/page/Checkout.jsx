        ...
        {checked && (
          <div className="col-1 ml-[6px] mt-[6px] relative row-1 size-[12px]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 12">
              <path d="M4.19632 10.2057C4.04557 10.2057 3.89481 10.148 3.77996 10.0332L0.172757 6.42585C-0.0575858 6.19562 -0.0575858 5.82336 0.172757 5.59312C0.402993 5.36289 0.775144 5.36289 1.00549 5.59312L4.19632 8.78396L10.9946 1.98582C11.2248 1.75558 11.597 1.75558 11.8273 1.98582C12.0575 2.21616 12.0575 2.58831 11.8273 2.81865L4.6128 10.0332C4.49795 10.148 4.34708 10.2057 4.19632 10.2057Z" fill="white" />
            </svg>
          </div>
        )}
      </div>
        ...
        <div className="relative py-[60px]">
          ...
          <div className="absolute content-stretch flex flex-col gap-[40px] items-start left-0 top-[213px]">
            ...
            <div className="content-stretch flex flex-col gap-[20px] items-start">
              ...
              <InputField placeholder="Apartment, Unit, etc(optional)" width="642px" />
          ...
          <div className="absolute left-0 top-[1104px]">
            ...
            <div className="w-[642px] h-0 relative mb-[30px]">
              <svg className="block w-full" fill="none" preserveAspectRatio="none" viewBox="0 0 642 1">
            ...
            <div className="w-[638px] h-0 mb-[30px]">
              <svg className="block w-full" fill="none" preserveAspectRatio="none" viewBox="0 0 638 1">
          ...
          <div className="absolute left-[680px] top-[1166px]">
            ...
            <div className="h-[56px] overflow-clip relative rounded-[6px] w-[238px] cursor-pointer">
              ...
              <div className="absolute h-[56px] right-0 top-0 w-[33px] pointer-events-none">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 33 56">
                  <path d="M26.561 0H33V56H0L26.561 0Z" fill="#F7F5F5" fillOpacity="0.21" />
                </svg>
              </div>
            </div>
          </div>
