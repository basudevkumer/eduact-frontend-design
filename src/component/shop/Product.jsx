...
const Product = () => {
  ...
  return (
    <div>
      <div>
        <Bredcrumb slug={"Shop"} slugHeading={"Products"} />
      </div>
      <Container>
        <div className="flex mt-30 mb-30">
          <div>
            <div className="w-75 h-20 bg-[#F57005] rounded-lg">
              <h1 className="flex items-center gap-x-1 pt-7 ml-7.5 text-[#FFFFFF]">
                {" "}
                <CiSearch />
                Type Here
              </h1>
            ...
            <div>
              <h2 className="border-b-2 border-dashed border-orange-500 w-76 pb-7.5 pt-7.5 text-[24px] font-semibold ">
                Categories
              </h2>
              <p className="flex items-center gap-x-2 text-[20px] mt-7.5 font-semibold font-Urbanist text-[#697585] shadow-md pb-7.5 w-[263px] ">
                {" "}
                <span className="text-[#F57005]">
                  <MdKeyboardDoubleArrowRight />
                </span>{" "}
                Web Development
              </p>

              <p className="flex items-center gap-x-2 text-[20px] font-semibold font-Urbanist text-[#697585] shadow-md pb-7.5 w-[263px] ">
                {" "}
                <span className="text-[#F57005]">
                  <MdKeyboardDoubleArrowRight />
                </span>{" "}
          ...
          <div>
            <div className=" flex items-center justify-between w-[981px] h-18 hover:shadow-lg hover:shadow-gray-300 rounded-lg  ">
              ...
              <p className="flex items-center gap-x-29 bg-[#F6F6F6]">
                Short By Popular <HiChevronDown />
              </p>
            </div>
            ...
            <div className=" w-[981px] mt-9 grid grid-cols-3 gap-9">
              <div className="w-76  bg-[#FFFFFF] px-19.5 hover:shadow-lg hover:shadow-gray-400 rounded-lg   ">
                <div className="space-y-3 pt-60 ">
                  ...
                  <p className="text-[20px] text-center text-[#697585]">
                    $25.00 <span className="text-[18px]">$30.00</span>
                  </p>
                  <p className="flex text-[#F57005] justify-center">
                    <FaStar /> <FaStar /> <FaStar /> <FaStar /> <FaStar />
                  </p>
                </div>
                <Link to={"/product_detailes"}>
                  <button className="bg-orange-500 hover:bg-orange-600 mt-6 mb-8 text-white font-medium py-2 px-6 rounded-lg transition duration-200">
                    Add to Cart
                  </button>
                </Link>
              </div>
